sap.ui.define([
	...
	return {
		...
		createODataModel: function(oOptions) {
			...
			if (!oOptions.url) {
				jQuery.sap.log.error("Please provide a url when you want to create an ODataModel",
					"oil/ups/fc/manageproject.model.models.createODataModel");
				return null;
			}
		...
		/**
		 * method to create the AppData Model
		 * 
		 * @returns{object} - AppData Model
		 * @public
		 */
		createAppDataModel : function(){
			var oAppDataModel = new JSONModel({
				isAuthToCreateProj : false
			});
			
			return oAppDataModel;
		}
